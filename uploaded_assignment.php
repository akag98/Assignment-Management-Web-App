...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="active" style="padding-left: 15px"><a href="uploaded_assignment.php">Assignments Uploaded</a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right">
        <li style="padding-right: 10px"><a href="index.php"><span class="glyphicon glyphicon-log-out"></span>Logout</a></li>
      </ul>
    </div>
  </nav>
  ...
  <div class="container">
    ...
    <table class="table table-hover">
      ...
      <tbody>
        ...
        $sql = "SELECT * from assignments where tid='".$_SESSION['user_name']."'";
        ...
        if ($result->num_rows > 0) {
          ...
          while($row = $result->fetch_assoc()){
            ...
            <tr>
              ...
              <td class="text-center"><a href="teacher_upload/<?php echo $row['Address'] ?>" class="btn btn-info btn-sm" target="_blank">View</a></td>       
            </tr>
            <?php
          } 
        }
